...
--------------------------------------------------------------------------------------------------------------------
If we do any changes chaincode side then follow the below commands :-

cd fabric-samples/test-network

./network.sh deployCC -ccn basic -ccp ../asset-transfer-basic/chaincode-typescript -ccl typescript -ccv 1.0.1
...
after that run below commads if chaincodeevery thing is fine:-

cd asset-transfer-basic/chaincode-typescript/src
npm run build

cd ../application-gateway-typescript/src
nvm use 20
