...
--------------------------
ssh -i "Downloads/democ.pem" ubuntu@3.7.97.129
...
===================================================================================================================================
https://3.29.241.35:8443/webui/

To connect with Terminal:
--------------------------
ssh -i "Downloads/democ.pem" ubuntu@3.29.241.35

old ip => 3.108.8.254

To connect warepro dev server db from eclipse/ postgres:
-----------------------------------------------------
host/addres: 3.29.241.35
port: 5432
user: adempiere
pwd: Welcome@1278
db: stonex_dev
...
scp -i /home/mahe/Downloads/democ.pem /home/mahe/Downloads/serverCode/download1.deb ubuntu@3.29.241.35:/home/ubuntu/WarePro
scp -i /home/mahe/Downloads/democ.pem /home/mahe/Downloads/ExpDat.dmp ubuntu@3.29.241.35:/home/ubuntu/WarePro

get data from server
----------------------
scp -i "Downloads/democ.pem" ubuntu@3.29.241.35:/home/ubuntu/Dumps/stonex_dev.dmp /home/mahe/Dumps/
...
===================================================================================================================================
https://3.28.239.34:8443/webui/ --old ip

https://3.28.239.34:8443/webui/

old ip=> 35.154.219.126


To connect with Terminal:
--------------------------
ssh -i "Downloads/democ.pem" ubuntu@3.28.239.34


To connect warepro dev server db from eclipse/ postgres:
-----------------------------------------------------
host/addres: 3.28.239.34
port: 5432
user: adempiere
pwd: Welcome@1278
db: stonex_qa
...
send to server:
--------------------
scp -i /home/mahe/Downloads/democ.pem /home/mahe/Dumps/stonex_dev13.dmp ubuntu@3.28.239.34:/home/ubuntu/WarePro
scp -i /home/mahe/Downloads/democ.pem /home/mahe/Downloads/ExpDat.dmp ubuntu@3.28.239.34:/home/ubuntu/WarePro

get data from server
----------------------
scp -i "Downloads/democ.pem" ubuntu@3.28.239.34:/home/ubuntu/Dumps/stonex_dev5.dmp /home/mahe/Dumps/
...
===================================================================================================================================
Vinay Electricals Dev server (maintained by pipra):
===================================================================================================================================


https://13.235.255.17:9444/webui/
...
----------------------
 host: 13.235.255.17
 or 
 ec2-13-235-255-17.ap-south-1.compute.amazonaws.com
 uName: adempiere
 pwd: Welcome@1278
 dbName: erpVe
...
get Data from server:
---------------------
scp -i "Downloads/democ.pem" ubuntu@13.235.255.17:/home/ubuntu/data.sql /home/mahe/
...
To connect with Terminal:
--------------------------
ssh -i "Downloads/rwpl-warepro.pem" ubuntu@15.206.25.170

To connect in Eclipse:
----------------------
 host: 15.206.25.170

running db in prod: prod_rwpl
...
ec2-15-206-25-170.ap-south-1.compute.amazonaws.com
 ...
 pg_dump -U adempiere -W prod_rwpl > prod_rwpl.dmp


get Data from server:
---------------------
scp -i "Downloads/rwpl-warepro.pem" ubuntu@15.206.25.170:/home/ubuntu/prod_rwpl2.dmp /home/mahe/Dumps/
...
createdb  --template=template0 -E UNICODE -O adempiere -U adempiere pipra_erp_prod1
psql -d pipra_erp_prod1 -U adempiere -c "ALTER ROLE adempiere SET search_path TO adempiere, pg_catalog"
psql -d pipra_erp_prod1 -U adempiere -c 'CREATE EXTENSION "uuid-ossp"'
psql -d pipra_erp_prod1 -U adempiere -f Dumps/pipra_erp_prod1.dmp 
...
createdb  --template=template0 -E UNICODE -O adempiere -U adempiere erp_prod
psql -d erp_prod -U adempiere -c "ALTER ROLE adempiere SET search_path TO adempiere, pg_catalog"
psql -d erp_prod -U adempiere -c 'CREATE EXTENSION "uuid-ossp"'
psql -d erp_prod -U adempiere -f  pipra_erp_template.dmp
...
===================================================================================================================================
java -cp /home/mahe/Downloads/xmlbeans-3.1.0.jar org.apache.xmlbeans.impl.tool.SchemaCompiler -javasource 11 -out lib/ve-xmlbeans.jar WEB-INF/xsd/ve.xsd
...
java -cp /home/mahe/Downloads/xmlbeans-3.1.0.jar org.apache.xmlbeans.impl.tool.SchemaCompiler -javasource 11 -out li
b/rwpl-xmlbeans.jar WEB-INF/xsd/rwpl.xsd
===================================================================================================================================
