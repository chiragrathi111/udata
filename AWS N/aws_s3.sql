...
* aws s3 ls s3://cogito-videos/

* aws s3 ls s3://cogito-videos/videos/

* aws s3 ls s3://cogito-videos/videos/ --recursive --human-readable --summarize  (Getting size)

Miggrate s3 reocrds one account to another account:-
